...
if ( ! class_exists( 'YITH_Role_Changer_User_Email' ) ) {
	...
	class YITH_Role_Changer_User_Email extends WC_Email {
		...
		public function __construct() {
			...
			$this->title = __( 'Automatic Role Changer email for User', 'yith-automatic-role-changer-for-woocommerce' );
			$this->description = __( 'The user will receive an email when a order with roles to be 
			granted passes to "Completed" or "Processing" status.', 'yith-automatic-role-changer-for-woocommerce' );

			$this->heading = __( "You've earned roles", 'yith-automatic-role-changer-for-woocommerce' );
			$this->subject = __( "You've earned roles", 'yith-automatic-role-changer-for-woocommerce' );
